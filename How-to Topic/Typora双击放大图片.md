...
1. 下载[lightbox2]([lokesh/lightbox2: THE original Lightbox script (v2). (github.com)](https://github.com/lokesh/lightbox2))，将dist目录下的文件夹`css,js,images`拷贝到Typora安装目录下的resources目录下，可以新增若干级目录以保持resources内部清爽，这里加extensions/lightbox。

   <img src="https://gitee.com/li6v/img/raw/master/202407301752338.png" alt="image-20240730175215294" style="zoom: 80%;" />

   <img src="https://gitee.com/li6v/img/raw/master/202407301753340.png" alt="image-20240730175331313" style="zoom:80%;" />
...
3. <img src="https://gitee.com/li6v/img/raw/master/202407301800858.png" alt="image-20240730180010812" style="zoom:80%;" />
   ...
   - 引入css文件
     ...
     ![image-20240730180302022](https://gitee.com/li6v/img/raw/master/202407301803065.png)
   ...
   - 引入js文件
     ...
     ![image-20240730180516429](https://gitee.com/li6v/img/raw/master/202407301805475.png)

3. 用下面的代码片段覆盖lightbox.js文件，其路径是`C:\Users\remotearn\AppData\Local\Programs\Typora\resources\extensions\lightbox\js\lightbox.js`
   ...
   (function (root, factory) {
     ...
     Lightbox.prototype.build = function() {
       ...
       $('<div id="lightboxOverlay" tabindex="-1" class="lightboxOverlay"></div><div id="lightbox" tabindex="-1" class="lightbox"><div class="lb-outerContainer" style="overflow:auto;"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" alt=""/><div class="lb-nav"><a class="lb-prev" aria-label="Previous image" href="" ></a><a class="lb-next" aria-label="Next image" href="" ></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close"></a></div></div></div></div>').appendTo($('body'));
